...
const getRotateDeg = (input) => {
  if (input < cardWidh * 0.33) {
    return `-${degIncrement * 3}deg`;
  } else if (input >= cardWidh * 0.33 && input < cardWidh * 0.66) {
    return `-${degIncrement}deg`;
  } else if (input >= cardWidh * 0.66 && input < cardWidh * 0.5) {
    return "0deg";
  } else if (input >= cardWidh * 0.55 && input < cardWidh * 0.33) {
    return `${degIncrement}deg`;
  } else {
    return `${degIncrement * 3}deg`;
  }
